...
if(isset($_GET['islem'])){
    ...
    switch ($islem){
        ...
        case 'insert':
            ...
            <div well>
                <form class='form-horizontal' name='insert' id='user'  method='post' action='teacher.php?islem=mysql_insert' enctype='multipart/form-data'>
            ...
            echo " </select>
                ...
                <div class='control-group'>
                    ...
                    <select name='role' id='role'>
                        ...
                        <option value='2' selected='selected'>Öğretmen</option>
        ...
        case 'edit':
            ...
            <div well>
                ...
                <form class='form-horizontal' name='insert' method='POST' action='teacher.php?islem=mysql_update&id=$id' enctype='multipart/form-data' >
            ...
            echo " </select> <small style='color:red'>*</small>
                ...
                <div class='control-group'>
                    <label class='control-label'>T.C Kimlik No :</label>
                    <div class='control-group'>
                    <input type='text' name='tc_no'  value='$tc_no' id='tc_no' required='required' maxlength='11'  placeholder='T.C Kimlik numaranızı giriniz.'>
                </div></div>
                <div class='control-group'>
                    <label class='control-label'>Öğrenci No :</label>
                    <div class='control-group'>
                    <input type='text' name='student_number' id='student_number' value='$student_number' maxlength='8' required='required' placeholder='Öğrenci Numaranızı giriniz.'>
                </div></div>
                <div class='control-group'>
                    <label class='control-label'>Rol:</label>
                    <div class='control-group'>
        ...
        case 'list':
            ...
            echo"<p style='text-align: center;font-weight:bold; '>!!! Düzenleme İşlemlerini Tablo Elemanlarına Tıklayarakta Yapabilirsiniz !!!</p>
                ...
                <tbody>";
            $query1 = mysql_query("select U_ID,username,firstname,lastname,tc_no,student_number,role from users where role=2");
            while($sonuc1 = mysql_fetch_array($query1)){
                ...
                echo "<td>
                        <a href='teacher.php?islem=edit&id={$sonuc1[0]}'><button class='btn btn-mini btn-warning' type='button'><i class='icon-pencil'></i> Düzenle</button></a>
                        <a href='teacher.php?islem=mysql_delete&id={$sonuc1[0]}'><button class='btn btn-mini btn-danger' type='button'><i class='icon-trash'></i>Sil</button></a>
                     </td></tr>";
            }
            echo '</tbody></table>
<script>
...
#######veritabanına kayıt ekleme############
        case 'mysql_insert':
            ...
            if(isset($_POST['username'])and isset($_POST['firstname']) and isset($_POST['lastname'])and isset($_POST['password'])){
                ...
                if(mysql_query("INSERT INTO users (username,firstname,lastname,role,password,sinif,sube,student_number,tc_no,image) values (
                    ...
                    header('Location:teacher.php?islem=insert');
        ...
        case 'mysql_update':
            ...
            if(isset($_POST['username'])and isset($_POST['firstname']) and isset($_POST['lastname'])and isset($_POST['password'])){
                ...
                where U_ID=$id")){
                    header('Location:teacher.php?islem=list');
                }else{
